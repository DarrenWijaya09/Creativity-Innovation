                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                            <div class="relative h-24 bg-gradient-to-r from-primary/20 to-blue-100"></div>
                            ...
                            <div class="px-6 pb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        @else
                                            ...
                                            <div id="avatarPlaceholder"
                                                class="w-24 h-24 rounded-full bg-primary text-white flex items-center justify-center text-3xl font-bold border-4 border-white shadow-md">
                                            ...
                                            <img id="avatarPreview"
                                                class="hidden w-24 h-24 rounded-full object-cover border-4 border-white shadow-md">
                                        @endif
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="flex items-center justify-center gap-2 mt-3">
                                        ...
                                        @if (Auth::user()->role == 0)
                                            <span
                                                class="px-2.5 py-1 bg-red-100 text-red-600 text-xs font-medium rounded-full">
                                        ...
                                        @else
                                            <span
                                                class="px-2.5 py-1 bg-yellow-100 text-yellow-700 text-xs font-medium rounded-full">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                            <h3 class="font-semibold text-gray-800 mb-3">Status Akun</h3>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-600">Google Terhubung</span>
                                    </div>
                                    <i class="fas fa-check-circle text-green-500 text-sm"></i>
                                </div>
                                <div class="flex items-center justify-between">
                ...
                <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="email" value="{{ Auth::user()->email }}" readonly
                                            class="w-full px-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 text-gray-500 focus:outline-none">
                                    ...
                                    {{-- <div class="md:col-span-2">
                                        ...
                                        <input type="file" name="avatar"
                                            class="w-full px-4 py-2.5 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        <div class="px-6 py-5 border-b border-gray-100">
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Kelola keamanan dan akses ke akun Anda</p>
                        </div>
                        <div class="divide-y divide-gray-100">
                            <div class="px-6 py-4 flex items-center justify-between">
                                <div>
                                    <h3 class="font-medium text-gray-800">Ubah Password</h3>
                                    <p class="text-xs text-gray-400 mt-0.5">Perbarui password secara berkala</p>
                                </div>
                                <button
                                    class="px-4 py-2 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition">
                                    Ubah
                                </button>
                            </div>
                            <div class="px-6 py-4 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-0.5">Tingkatkan keamanan akun Anda</p>
                                </div>
                                <button
                                    class="px-4 py-2 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition">
                                    Aktifkan
                            ...
                            <div class="px-6 py-4 flex items-center justify-between">
                                <div>
                                    <h3 class="font-medium text-gray-800">Login Terakhir</h3>
                                    <p class="text-xs text-gray-400 mt-0.5">2 Mei 2025, 14:30 WIB • Perangkat: Chrome /
                                        Windows</p>
                                </div>
                                <i class="fas fa-shield-alt text-primary text-sm"></i>
                            </div>
                    ...
                    <div
                        class="bg-gradient-to-r from-primary/5 to-blue-50 rounded-2xl border border-primary/20 shadow-sm overflow-hidden">
                        <div class="px-6 py-6">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div class="flex items-center gap-2 mb-2">
                                        <i class="fas fa-store text-primary text-xl"></i>
                                        <h2 class="text-lg font-bold text-gray-900">Status Penyedia</h2>
                                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        <div class="px-6 py-5 border-b border-gray-100">
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Atur notifikasi dan tampilan sesuai kebutuhan</p>
                        </div>
                        <div class="divide-y divide-gray-100">
                            <div class="px-6 py-4 flex items-center justify-between">
                                <div>
                                    <h3 class="font-medium text-gray-800">Notifikasi Email</h3>
                                    <p class="text-xs text-gray-400 mt-0.5">Terima update pesanan dan promo via email</p>
                                </div>
                            ...
                            <div class="px-6 py-4 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-0.5">Preferensi bahasa tampilan</p>
                                </div>
                                <select
                                    class="px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50">
                    ...
                    <div class="bg-red-50/30 rounded-2xl border border-red-200 overflow-hidden">
                        <div class="px-6 py-5">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <h3 class="font-semibold text-red-700">Hapus Akun</h3>
                                    <p class="text-sm text-red-600/70 mt-0.5">Tindakan ini tidak dapat dibatalkan</p>
                                </div>
                                <button
                                    class="px-4 py-2 bg-white border border-red-300 text-red-600 text-sm font-medium rounded-xl hover:bg-red-50 transition">
                                    Hapus Akun
                                </button>
                            </div>
                        </div>
