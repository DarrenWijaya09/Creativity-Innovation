...
@section('content')
    <!-- ==================== HERO SECTION - REDESIGNED PREMIUM CLEAN ==================== -->
    <section class="relative overflow-hidden bg-white">
        <!-- Subtle ambient glow - only ONE layer -->
        <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-400/15 rounded-full blur-[120px] -z-10"></div>
        <div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-400/10 rounded-full blur-[100px] -z-10"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-28">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="text-center lg:text-left">
                    <!-- Trust Badge -->
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-secondary rounded-full mb-6">
                    ...
                    <!-- Headline -->
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-gray-900 leading-[1.15] mb-6">
                        Temukan
                    ...
                    <!-- Subheadline -->
                    <p class="text-gray-500 text-base md:text-lg max-w-lg mx-auto lg:mx-0 leading-relaxed mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                        ...
                        <a href="{{ route('provider.create') }}"
                           class="inline-flex items-center justify-center gap-2 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-3.5 rounded-full transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    <div class="flex flex-wrap gap-6 justify-center lg:justify-start">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-xs text-gray-500">Penyedia Aktif</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-xs text-gray-500">Rating Pengguna</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <div class="text-left">
                                <p class="text-sm font-semibold text-gray-900">100%</p>
                                <p class="text-xs text-gray-500">Garansi Aman</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative w-full max-w-md lg:max-w-lg">
                        ...
                        <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                            <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&h=600&fit=crop"
                                 ...
                                 class="w-full h-auto object-contain relative z-0 transform transition-transform duration-500 hover:scale-105">
                        </div>

                        <!-- Minimal Verified Badge (Only One Floating Element) -->
                        <div class="absolute -bottom-3 -right-3 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-2.5 shadow-lg border border-gray-100 flex items-center gap-2">
                            <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                                <i class="fas fa-check-circle text-primary text-sm"></i>
                            </div>
                            <div>
                                <p class="text-xs font-semibold text-gray-800">10.000+</p>
                                <p class="text-[10px] text-gray-500">Penyedia Terverifikasi</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-12 border-t border-gray-100 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-2xl md:text-3xl font-semibold text-gray-900">Jelajahi Kategori</h2>
                <p class="text-gray-500 mt-2 text-sm">Temukan layanan berdasarkan kebutuhan Anda</p>
            </div>
                ...
                <div class="flex gap-3 md:justify-center min-w-max">
                    ...
                    @foreach($categories as $category)
                        <a href="{{ route('catalog.index', ['category[]' => $category]) }}"
                           class="category-pill flex-shrink-0 inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:bg-primary hover:text-white hover:border-primary transition-all duration-200 shadow-sm hover:shadow-md hover:-translate-y-0.5">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-end justify-between flex-wrap mb-10">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Temukan layanan yang sedang banyak dicari</p>
                </div>
                <a href="{{ url('/catalog') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @forelse($popularServices as $service)
                    <div class="group bg-white rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 overflow-hidden relative">
                        ...
                        @auth
                            ...
                            @if($isSaved)
                                <form action="{{ route('saved.destroy', $service->id) }}" method="POST" class="absolute top-3 right-3 z-10">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="w-8 h-8 rounded-full bg-white/90 backdrop-blur shadow-sm flex items-center justify-center text-red-500 hover:text-red-600 transition hover:scale-110">
                            ...
                            @else
                                <form action="{{ route('saved.store', $service->id) }}" method="POST" class="absolute top-3 right-3 z-10">
                                    @csrf
                                    <button type="submit" class="w-8 h-8 rounded-full bg-white/90 backdrop-blur shadow-sm flex items-center justify-center text-gray-400 hover:text-red-500 transition hover:scale-110">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="absolute top-3 right-3 z-10">
                                <div class="w-8 h-8 rounded-full bg-white/90 backdrop-blur shadow-sm flex items-center justify-center text-gray-400 hover:text-red-500 transition hover:scale-110">
                                    <i class="far fa-heart text-sm"></i>
                                </div>
                            </a>
                        @endauth
                        ...
                        <a href="{{ route('catalog.show', $service->slug) }}" class="block">
                            <div class="card-image-zoom">
                                <img src="{{ $service->image ? (Str::startsWith($service->image, 'http') ? $service->image : asset('storage/' . $service->image)) : 'https://placehold.co/400x300/png?text=No+Image' }}"
                                    alt="{{ $service->title }}" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                            </div>
                            <div class="p-5">
                                <h3 class="font-bold text-gray-900 text-lg line-clamp-1 group-hover:text-primary transition">{{ $service->title }}</h3>
                                <p class="text-gray-500 text-sm mt-1">{{ optional($service->provider)->name ?? 'Penyedia' }}</p>
                                <div class="flex items-center gap-2 mt-2">
                                    <div class="flex items-center gap-1">
                                        <i class="fas fa-star text-yellow-400 text-sm"></i>
                                        <span class="font-semibold text-gray-800">{{ number_format($service->rating ?? 0, 1) }}</span>
                                    </div>
                                    <span class="text-xs text-gray-400">({{ number_format($service->total_orders ?? 0) }} pesanan)</span>
                                </div>
                                <div class="mt-3">
    ...
    <section class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-10 border border-gray-100 shadow-sm">
                <div class="flex-1 text-center md:text-left space-y-4">
                    ...
                    <div class="flex justify-center md:justify-start gap-3 pt-2">
                        <div class="bg-gray-50 rounded-xl px-4 py-2 shadow-sm text-center min-w-[60px] border border-gray-100">
    ...
    <!-- LAYANAN LAINNYA (Recommended) -->
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-end justify-between flex-wrap mb-10">
                <div>
                    <h2 class="text-2xl md:text-3xl font-semibold text-gray-900">✨ Rekomendasi untuk Anda</h2>
                    <p class="text-gray-500 text-sm mt-1">Berdasarkan aktivitas dan preferensi Anda</p>
                </div>
