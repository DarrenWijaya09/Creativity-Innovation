...
@section('content')
    <div class="bg-white min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div
                class="relative bg-gradient-to-r from-primary/5 via-transparent to-blue-50/30 rounded-3xl p-6 md:p-8 mb-8 overflow-hidden">
                ...
                <div class="flex flex-col lg:flex-row gap-6 items-start">
                    ...
                    <div class="flex items-center gap-5 flex-1">
                        <div class="relative">
                            <div
                                class="w-24 h-24 lg:w-32 lg:h-32 rounded-full bg-gradient-to-br from-primary/20 to-blue-100 flex items-center justify-center text-primary text-3xl font-bold overflow-hidden">
                                @if ($provider->avatar)
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-2 flex-wrap">
                                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">{{ $provider->name }}</h1>
                    ...
                    <div class="flex flex-wrap gap-4 lg:gap-6">
                        <div class="text-center min-w-[80px]">
                            <div class="flex items-center gap-1 justify-center">
                                ...
                                <span
                                    class="text-xl font-bold text-gray-900">{{ number_format($provider->average_rating, 1) }}</span>
                            </div>
                            <p class="text-xs text-gray-500">{{ number_format($provider->total_reviews) }} ulasan</p>
                        </div>
                        <div class="text-center min-w-[80px]">
                            <div class="text-xl font-bold text-gray-900">{{ number_format($provider->total_orders) }}</div>
                            <p class="text-xs text-gray-500">Total Pesanan</p>
                        </div>
                        <div class="text-center min-w-[80px]">
                            <div class="text-xl font-bold text-gray-900">{{ $provider->services_count }}</div>
                            <p class="text-xs text-gray-500">Jasa</p>
                        </div>
                        <div class="text-center min-w-[80px]">
                            <div class="text-xl font-bold text-gray-900">{{ $provider->response_time ?? '< 1 jam' }}</div>
                            <p class="text-xs text-gray-500">Respon</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-3 mt-6 pt-4 border-t border-gray-100">
                    <button
                        class="flex-1 sm:flex-none px-6 py-2.5 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 transition shadow-sm">
                        <i class="fas fa-paper-plane mr-2"></i> Pesan Jasa
                    </button>
                    <button
                        class="flex-1 sm:flex-none px-6 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition">
                        <i class="fab fa-whatsapp mr-2"></i> Hubungi
                    </button>
                    <button
                        class="px-6 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-10">
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $provider->services_count }}</p>
                    <p class="text-xs text-gray-500">Total Jasa</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                    <i class="fas fa-shopping-bag text-primary text-xl mb-2"></i>
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($provider->total_orders) }}</p>
                    <p class="text-xs text-gray-500">Pesanan Selesai</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                    <i class="fas fa-star text-primary text-xl mb-2"></i>
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($provider->average_rating, 1) }}</p>
                    <p class="text-xs text-gray-500">Rating Rata-rata</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 shadow-sm">
                    <i class="fas fa-smile text-primary text-xl mb-2"></i>
                    <p class="text-2xl font-bold text-gray-900">{{ $provider->satisfaction_rate ?? 98 }}%</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-4">Tentang {{ $provider->name }}</h2>
                        <div class="prose max-w-none">
                            <p class="text-gray-600 leading-relaxed" id="providerBio">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100">
                            <h3 class="font-semibold text-gray-800 mb-3">Spesialisasi</h3>
                            <div class="flex flex-wrap gap-2">
                                ...
                                @foreach ($specializations as $spec)
                                    <span
                                        class="px-3 py-1 bg-gray-100 text-gray-600 text-xs rounded-full">{{ trim($spec) }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-500">Belum ada portfolio yang ditampilkan</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sticky top-24">
                        <h3 class="font-semibold text-gray-900 mb-4">Informasi Penyedia</h3>
                        <div class="space-y-3">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Verifikasi</span>
                                <span class="flex items-center gap-1 text-green-600"><i class="fas fa-check-circle"></i>
                                    Terverifikasi</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Kecepatan Respon</span>
                                <span class="font-medium text-gray-800">{{ $provider->response_time ?? '< 1 jam' }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Terakhir Aktif</span>
                                <span
                                    class="font-medium text-gray-800">{{ $provider->last_active_at ? $provider->last_active_at->diffForHumans() : 'Hari ini' }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Tingkat Penyelesaian</span>
                                <span class="font-medium text-gray-800">{{ $provider->completion_rate ?? 98 }}%</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Bahasa</span>
                                <span class="font-medium text-gray-800">Indonesia, English</span>
                            </div>
            ...
            <div class="mb-10">
                <div class="flex items-center justify-between flex-wrap gap-4 mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Layanan yang Ditawarkan</h2>
                        <p class="text-gray-500 text-sm mt-1">Jasa unggulan dari {{ $provider->name }}</p>
                    </div>
                    <div class="flex gap-2">
                        <button
                            class="service-tab active px-4 py-2 text-sm font-medium rounded-lg bg-primary/10 text-primary">Terbaru</button>
                        <button
                            class="service-tab px-4 py-2 text-sm font-medium rounded-lg text-gray-500 hover:bg-gray-100 transition">Populer</button>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($services as $service)
                            <a href="{{ route('catalog.show', $service->id) }}"
                                class="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
                                <div class="relative overflow-hidden h-48">
                                    ...
                                    <div class="absolute top-3 left-3">
                                        <span
                                            class="px-2 py-1 bg-white/90 backdrop-blur-sm text-xs font-medium rounded-full text-gray-700">
                                ...
                                <div class="p-5">
                                    <h3
                                        class="font-bold text-gray-900 text-lg line-clamp-1 group-hover:text-primary transition">
                                        {{ $service->title }}</h3>
                                    <div class="flex items-center gap-2 mt-2">
                                        <div class="flex items-center gap-1">
                                            <i class="fas fa-star text-yellow-400 text-xs"></i>
                                            <span
                                                class="text-sm font-semibold">{{ number_format($service->average_rating, 1) }}</span>
                                        </div>
                                        <span class="text-xs text-gray-400">({{ number_format($service->orders_count) }}
                                            pesanan)</span>
                                    </div>
                ...
                @else
                    <div class="bg-gray-50 rounded-2xl p-12 text-center">
                        ...
                        <h3 class="font-semibold text-gray-800 mb-2">Belum ada jasa yang ditawarkan</h3>
                        <p class="text-sm text-gray-500">Penyedia jasa ini belum menambahkan layanan apapun</p>
                    </div>
                @endif
            </div>
            ...
            <div class="mb-10">
                <div class="flex items-center justify-between flex-wrap gap-4 mb-6">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Apa kata mereka tentang {{ $provider->name }}</p>
                    </div>
                    <div class="flex gap-2">
                        <select
                            class="review-sort px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-primary">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 items-center">
                        <div class="text-center">
                            ...
                            <div class="flex items-center justify-center gap-1 my-1">
                                @for ($i = 1; $i <= 5; $i++)
                                    <i
                                        class="fas fa-star text-sm {{ $i <= round($provider->average_rating) ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                @endfor
                            </div>
                            <div class="text-sm text-gray-500">{{ number_format($provider->total_reviews) }} ulasan</div>
                        </div>
                        <div class="flex-1 space-y-2">
                            @foreach ([5, 4, 3, 2, 1] as $star)
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs text-gray-500 w-12">{{ number_format($percentage, 0) }}%</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
                ...
                @if (isset($reviews) && $reviews->count() > 0)
                    <div class="space-y-4" id="reviewsContainer">
                        @foreach ($reviews as $review)
                            <div class="bg-white rounded-xl p-5 border border-gray-100 hover:shadow-sm transition">
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-semibold text-sm overflow-hidden flex-shrink-0">
                ...
                @else
                    <div class="text-center py-12 bg-gray-50 rounded-2xl">
                        ...
                        <p class="text-gray-500">Belum ada ulasan untuk penyedia ini</p>
            ...
            @if (isset($relatedProviders) && $relatedProviders->count() > 0)
                <div class="mb-10">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Penyedia Serupa</h2>
                            <p class="text-gray-500 text-sm mt-1">Provider lain yang mungkin Anda minati</p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        @foreach ($relatedProviders as $related)
                            <a href="{{ route('providers.show', $related->id) }}"
                                class="bg-white rounded-xl p-4 border border-gray-100 hover:shadow-md transition text-center group">
                                <div
                                    class="w-16 h-16 rounded-full mx-auto bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-gray-500 text-lg font-bold overflow-hidden">
                                    @if ($related->avatar)
                                ...
                                <h3 class="font-semibold text-gray-800 text-sm mt-2 group-hover:text-primary transition">
                                    {{ $related->name }}</h3>
                                <div class="flex items-center justify-center gap-1 mt-1">
                                    <i class="fas fa-star text-yellow-400 text-xs"></i>
                                    <span
                                        class="text-xs font-semibold">{{ number_format($related->average_rating, 1) }}</span>
                                </div>
                                <p class="text-xs text-gray-500 mt-1">{{ $related->services_count }} jasa</p>
                            </a>
                        @endforeach
                    </div>
                </div>
