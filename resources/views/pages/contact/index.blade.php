...
<div class="animate-fade-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <h2 class="text-xl font-bold text-gray-800 mb-6">Kirim Pesan ke Kami</h2>
                ...
                <form action="#" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Contoh: Budi Santoso"
                                   class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-gray-700 font-medium mb-2">Email <span class="text-red-500">*</span></label>
                            <input type="email" name="email" placeholder="budi@example.com"
                                   class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="category" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 bg-white">
                            <option value="">Pilih kategori</option>
                            <option value="pesanan">Masalah Pesanan</option>
                            <option value="pembayaran">Pembayaran</option>
                            <option value="akun">Akun & Pendaftaran</option>
                            <option value="penyedia">Menjadi Penyedia</option>
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="5" placeholder="Ceritakan masalah atau pertanyaan Anda secara detail..."
                                  class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"></textarea>
                    </div>

                    <button type="submit" class="bg-primary hover:bg-primary/90 text-white font-semibold px-6 py-3 rounded-xl transition shadow-sm w-full md:w-auto">
                        <i class="fas fa-paper-plane mr-2"></i> Kirim Pesan
                    </button>

                    <p class="text-xs text-gray-400 mt-3">
                        <i class="fas fa-lock text-xs"></i> Data Anda aman. Kami akan merespon dalam 1x24 jam.
                    </p>
                </form>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <a href="mailto:hello@vexora.com" class="text-primary font-medium text-sm hover:underline block mt-2">hello@vexora.com</a>
                <a href="mailto:support@vexora.com" class="text-primary font-medium text-sm hover:underline block">support@vexora.com</a>
            </div>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <a href="https://wa.me/6281234567890" class="text-green-600 font-medium text-sm hover:underline block mt-2">+62 812 3456 7890</a>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition">
                ...
                <div class="mt-2 space-y-1 text-sm">
                    <p class="flex justify-between"><span class="text-gray-500">Senin - Jumat</span><span class="text-gray-800">09:00 - 18:00</span></p>
                    <p class="flex justify-between"><span class="text-gray-500">Sabtu</span><span class="text-gray-800">10:00 - 15:00</span></p>
                    <p class="flex justify-between"><span class="text-gray-500">Minggu</span><span class="text-gray-800">Tutup</span></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Cukup cari penyedia jasa sesuai kebutuhan, pilih layanan, lalu klik "Pesan Sekarang". Ikuti instruksi pembayaran, dan penyedia akan menghubungi Anda.</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Klik tombol "Jadi Penyedia" di halaman utama, isi formulir pendaftaran, lengkapi profil dan layanan Anda. Tim kami akan melakukan verifikasi dalam 1x24 jam.</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Kami mendukung transfer bank (BCA, Mandiri, BRI, BNI), e-wallet (GoPay, OVO, Dana), dan kartu kredit/debit.</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Ya, VEXORA memberikan garansi kepuasan. Jika layanan tidak sesuai, Anda dapat mengajukan komplain dan tim kami akan membantu menyelesaikan.</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">VEXORA tidak membebankan biaya tambahan kepada pengguna. Harga yang ditampilkan adalah harga dari penyedia jasa. Untuk penyedia, kami mengenakan komisi transaksi yang transparan.</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Klik "Lupa Password" di halaman login, masukkan email terdaftar. Kami akan mengirimkan link reset password ke email Anda.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mb-16">
        <div class="bg-gradient-to-r from-primary to-blue-600 rounded-3xl p-10 md:p-12 text-center text-white shadow-xl">
            ...
            <a href="#" class="inline-block bg-white text-primary font-semibold px-8 py-3 rounded-full hover:bg-gray-100 transition shadow-md">
                Daftar Sekarang →
            </a>
        </div>
    </section>
    ...
    <section class="pb-8">
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
            ...
            <p class="text-gray-500 text-sm">Gedung VEXORA, Jalan Teknologi No. 123, Jakarta Selatan, Indonesia 12190</p>
        </div>
    </section>
